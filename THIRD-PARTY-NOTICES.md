...
repository on Hugging Face and verifies its SHA-256 checksum before use:

<https://huggingface.co/ggerganov/whisper.cpp>

The full `whisper.cpp` and `ggml` license texts are copied into the application
bundle during the release build.
