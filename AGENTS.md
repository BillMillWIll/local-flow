...
These instructions apply to every AI session working in this repository.
...
2. Read `DISTRIBUTION.md` before changing packaging, versions or releases.
...
- Local repository:
  `~/Desktop/ArtMotion-Antigravity/docs/local-flow`
- Public repository:
  `https://github.com/BillMillWIll/local-flow`
